...
const indexScene: DemoScene<RagEventKind> = {
  id: "index",
  act: 1,
...
const retrieveScene: DemoScene<RagEventKind> = {
  id: "retrieve",
  act: 2,
...
const generateScene: DemoScene<RagEventKind> = {
  id: "generate",
  act: 3,
...
export const ragPhaseStories: Readonly<Record<RagPhase, DemoStory<RagEventKind>>> = {
  index: {
    id: "rag-index",
    title: "Retrieval-Augmented Generation / Index",
    scenes: [indexScene],
  },
  retrieve: {
    id: "rag-retrieve",
    title: "Retrieval-Augmented Generation / Retrieve",
    scenes: [retrieveScene],
  },
  generate: {
    id: "rag-generate",
    title: "Retrieval-Augmented Generation / Generate",
...
export const ragStory: DemoStory<RagEventKind> = {
  ...
  scenes: [indexScene, retrieveScene, generateScene],
};
